...
public class ItemStackView extends GuiElement
{
    ...
    private Consumer<List<? extends StringRenderable>> stackTooltipModifier;
    ...
    public Consumer<List<? extends StringRenderable>> getStackTooltipModifier()
    {
        return this.stackTooltipModifier;
    }

    public void setStackTooltipModifier(Consumer<List<? extends StringRenderable>> stackTooltipModifier)
    {
